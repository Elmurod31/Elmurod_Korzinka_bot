...
korzinka_btn2 = ReplyKeyboardMarkup(
    ...
    [KeyboardButton(text="Chegirma va aktsiyalar 🔥"), KeyboardButton(text="Haridingiz uchun sovg'alar 🔱")],
...
korzinka_btn2_ru = ReplyKeyboardMarkup(
    keyboard=[
        [KeyboardButton(text="Карта Карзинка 💳"), KeyboardButton(text="⚡️ Программа «Ещё дешевле»")],
